...
E.g.: Set an EntityBlocker as the target of any kind of
trigger (EntityTrigger, EntityWaypoint, etc). When the
triggeredBy call is received, this will stop the (triggering)
entity in its track.
