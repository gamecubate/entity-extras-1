/*
Entity that calls the triggeredBy method of one or more targets when
it and other entity of a specific collision type overlap with the
...
enabled
	Waypoint is operational (true) or not (false)
	Default: true
